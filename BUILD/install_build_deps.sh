...
then
  ...
  sudo apt-get install -y --force-yes dpkg-dev git wget \
       ...
       libedit-dev libcurl4-openssl-dev libldap2-dev
  ...
  then
    ...
    sudo zypper -n install gcc gcc-c++ ncurses-devel bison glibc-devel libgcc_s1 perl \
         ...
         gnutls-devel libgcrypt-devel pam-devel systemd-devel libcurl-devel openldap-devel
    ...
    sudo yum install -y --nogpgcheck gcc gcc-c++ ncurses-devel bison glibc-devel \
         ...
         gnutls-devel libgcrypt-devel pam-devel libcurl-devel openldap-devel
